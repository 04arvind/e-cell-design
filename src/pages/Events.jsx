...
import { Calendar, MapPin, Search, Sliders, ArrowRight, Eye } from 'lucide-react';
    ...
    return (
        <Layout>
            ...
            <section className="relative px-6 py-12 lg:px-20 lg:py-20 max-w-7xl mx-auto">
                <div className="relative overflow-hidden rounded-3xl bg-neutral-dark p-8 lg:p-16 border border-white/5">
            ...
            {/* Filters */}
            <section className="px-6 py-4 lg:px-20 sticky top-[73px] z-40 bg-background-dark/95 backdrop-blur-sm border-b border-white/5">
