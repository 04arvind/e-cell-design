...
import { Rocket, Mail, Globe, Share2 } from 'lucide-react';
    ...
    return (
        <footer className="bg-neutral-dark text-white pt-20 pb-10 px-6 lg:px-20 border-t border-white/5">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                <div className="md:col-span-1">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="bg-primary p-1.5 rounded-lg">
                            <Rocket className="text-neutral-dark size-5" />
                        </div>
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm text-neutral-muted">
                        ...
                        <li><Link to="/team" className="hover:text-primary transition-colors">Success Stories / Team</Link></li>
                    </ul>
                </div>
            ...
            <div className="max-w-7xl mx-auto pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
                <p className="text-xs text-neutral-muted">© 2024 E-Cell HMRITM. Designed for the builders of tomorrow.</p>
